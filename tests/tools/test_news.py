...
from volatility_explainer.tools import news
...
def test_finnhub_used_when_key_configured_and_capped_at_five():
    ...
    with patch("volatility_explainer.tools.news.get_settings", return_value=_fake_settings("KEY")), \
...
def test_falls_back_to_yfinance_when_no_finnhub_key():
    ...
    with patch("volatility_explainer.tools.news.get_settings", return_value=_fake_settings("")), \
