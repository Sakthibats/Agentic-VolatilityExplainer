...
import pandas as pd
from volatility_explainer.tools import macro
...
def test_uses_fred_when_key_configured():
    ...
    with patch("volatility_explainer.tools.macro.get_settings", return_value=_fake_settings("KEY")), \
...
def test_falls_back_to_yfinance_when_no_fred_key():
    ...
    with patch("volatility_explainer.tools.macro.get_settings", return_value=_fake_settings("")), \
